...
O botão deve alterar para "Remove".  
O contador do carrinho deve ser incrementado.  
...
O botão deve voltar para "Add to cart".  
...
O carrinho deve exibir apenas os produtos adicionados anteriormente.  
Os produtos exibidos devem corresponder aos itens selecionados.  
...
Os produtos já adicionados devem permanecer no carrinho.
