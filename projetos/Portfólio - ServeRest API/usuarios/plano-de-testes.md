...
Escopo de teste: Validação dos endpoints de login, listagem, cadastro, consulta por ID, atualização, exclusão de usuários e códigos HTTP.

Fora do escopo: Endpoints de produtos e carrinhos.
...
Ambiente e dados: Postman, token de autenticação e dados de teste válidos e inválidos para validação de endpoints.
