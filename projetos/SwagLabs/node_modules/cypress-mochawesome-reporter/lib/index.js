const fse = require('cypress-mochawesome-reporter/node_modules/fs-extra');
const path = require('path');
const { setConfig } = require('cypress-mochawesome-reporter/lib/config');
const { log, debugLog } = require('cypress-mochawesome-reporter/lib/logger');
